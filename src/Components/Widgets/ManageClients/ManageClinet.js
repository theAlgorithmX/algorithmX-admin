...
const ManageClients = () => {
  ...
  const openEditModal = (client) => {
    ...
    setValue(
      "image",
      client.brandLogo || client.image_url || client.image || null
    );
    setValue(
      "imageAltText",
      client.imageAltText || client.image_alt || client.alt_text || ""
    );
                    ...
                    <tr key={client.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                          ...
                          <button
                            onClick={() =>
                              deleteClient(client.id, client.title)
                            }
                            disabled={loading}
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Optional: Provide alternative text for screen readers and
                    accessibility
                  </p>
                </div>
