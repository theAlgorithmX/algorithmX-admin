  ...
  return (
    <div className="bg-white py-10">
      <div className="rounded-lg shadow-lg p-4 max-w-7xl mx-auto">
        ...
        <Editor
          apiKey="jnwzo6x0ch3vfi76ixspm2353f8kmb7rp87xiqlaksgesnxh" // Remember to replace with your actual API key
          onInit={(evt, editor) => {
          ...
          init={{
            ...
            // --- CORRECTED SECTION ---
            // This handler is now correctly returning a Promise for drag-and-drop or paste uploads.
