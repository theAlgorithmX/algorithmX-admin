      ...
      <CardHeader className="card-no-border">
        <div className="header-top">
          ...
          <div className="card-header-right-icon">
            <DropdownCommon
              icon={false}
              options={CryptoDropdown}
              btn={{ caret: true, direction: "end" }}
            />
          </div>
        </div>
      </CardHeader>
          ...
          <Col xxl="12" xl="7" sm="6" className="box-col-6">
            <div className="portfolio-chart-container">
              {/* <ReactApexChart
                type="radialBar"
                height={280}
                options={myPortfolioChartOption.options}
                series={myPortfolioChartOption.series}
              /> */}
            </div>
          </Col>
                  ...
                  {portfolioLegend.map((item, i) => (
                    <tr key={i}>
                      ...
                      <td className="text-end">
                        ...
                        <span className={`font-${item.status}`}>
                          ${item.totalPrice}
                        </span>
                      </td>
                    </tr>
